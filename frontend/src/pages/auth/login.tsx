...
const Login: FC = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      notifySuccess("Account accessed successfully");
          ...
          <Box style={{ ...styles.body, width: isSmallScreen ? "85%" : "70%" }}>
            <Box style={styles.main}>
              ...
              <Text style={{ ...styles.title, ...baseAnim(0.10) }}>
                Welcome back to Thinkly
              </Text>
              <Text style={{ ...styles.subtitle, ...baseAnim(0.15) }}>
                Please enter your details to access your Thinkly account
              </Text>
            </Box>
            ...
            <Box style={styles.inputs}>
              ...
              <label style={{ ...styles.label, ...baseAnim(0.35) }}>Password</label>
              <Box style={{ ...styles.input, ...baseAnim(0.38) }}>
                <input
