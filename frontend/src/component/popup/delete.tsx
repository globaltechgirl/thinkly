...
const Delete: FC<{ onClose: () => void; onConfirm: () => void; quiz: Quiz; loading?: boolean; }> = ({ onClose, onConfirm, loading = false }) => {
      ...
      <Box onClick={(e) => e.stopPropagation()} style={styles.wrapper} className="scroll">
        <Box style={styles.main}>
          <Box style={styles.header}>
            <Text style={styles.title}>Delete Quiz</Text>
            <IconX style={styles.close} onClick={onClose} />
          </Box>

          <Box style={styles.content}>
            <Text style={styles.label}>Are you sure you want to delete this quiz?</Text>
